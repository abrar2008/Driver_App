class OrderDetailModel {
  ...
  OrderDetailModel({this.code, this.msg, this.details});
  ...
  OrderDetailModel.fromJson(Map<String, dynamic> json) {
    ...
    details =
    json['details'] != null ? new OrderDetails.fromJson(json['details']) : null;
  }
...
class OrderDetails {
  ...
  OrderDetails({this.item, this.total, this.settings, this.orderInfo});
