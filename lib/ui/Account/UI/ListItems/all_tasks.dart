...
class UserDetails extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final lang = Provider.of<GlobalTranslations>(context, listen: false);
    return Consumer<AllTasksPageModel>(
        ...
        child: BaseWidget<AllTasksPageModel>(
            ...
            builder: (context, model, child) {
                ...
                appBar: AppBar(
                    ...
                    actions: <Widget>[
                      !model.accountstatus
                        ...
                        child: model.offline && PrefKeys.locationPer == null
                            ? FlatButton(
                          color: Colors.red,
                          onPressed: () async {
              final permession =
              ...
              color: Colors.white),
                ...
                children: <Widget>[
                  buildTopButtons(model, lang),
                  buildBody(model, lang, context)
                ],
                ));
            }),
