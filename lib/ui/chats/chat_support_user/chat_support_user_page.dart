...
import 'chat_support_user_controller.dart';

class ChatSupportUserPage extends StatefulWidget {
  @override
  _ChatSupportUserPageState createState() => _ChatSupportUserPageState();
}

class _ChatSupportUserPageState extends State<ChatSupportUserPage> {
  final ChatSupportUserController controller =
      Get.put(ChatSupportUserController());

  @override
  void dispose() {
    Get.delete<ChatSupportUserController>();
    super.dispose();
  }
