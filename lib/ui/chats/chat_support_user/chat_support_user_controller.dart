...
class ChatSupportUserController extends GetxController {
  static ChatSupportUserController get to => Get.find();
  ...
  CollectionReference get messagesCollection => FirebaseFirestore.instance
      .collection("chats_support_user")
      .doc(chat?.id)
      .collection("messages");

  DocumentReference get chatDocument =>
      FirebaseFirestore.instance.collection("chats_support_user").doc(chat?.id);
